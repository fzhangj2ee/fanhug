# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It features a user-friendly interface for registration and login, supporting both traditional email/password and OAuth2 for social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for efficient user management. Recent updates include a donation page, improved bet slip functionality, and enhanced user experience features, such as a scrollable bet slip and a collapsible "View Bets Details" section.
