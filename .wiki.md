# Project Summary
FanHug is a web application that enhances the live sports betting experience by providing a user-friendly interface. Users can register using email/password or OAuth2 social accounts, and the app integrates with Stripe for secure payments while leveraging The Odds API for real-time betting data. Notable features include automated bet grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration of functionalities, promoting responsible gaming.
...
└── src/contexts/BettingContext.tsx # Updated betting context with defensive checks
