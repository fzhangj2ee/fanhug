# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It provides a user-friendly interface, allowing users to register and log in through traditional email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and delivering live updates. An admin dashboard facilitates efficient user management. Recent enhancements include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and a version number display in the header for easy identification of the deployed version.
...
- **Version Display**:
  - Displays the current version number in the navbar, positioned right after the FanHug logo, styled subtly for clarity.
...
- **src/components/**: UI components, including updated betting components and Navbar with logo and version display.
