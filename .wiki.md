# Project Summary
PayApp is a secure payment web application designed for seamless payment processing and live sports betting. It provides an intuitive user experience for registration and login via traditional methods or OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data. Key features include automatic grading of bets, real-time updates, and user-friendly betting functionalities. Recent updates have improved error handling and enhanced the betting experience with a fully functional GameCard component.
