# Project Summary
FanHug is a secure web application designed to enhance the live sports betting experience with an intuitive user interface. Users can register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for user management, and the application features a play money display for easy wallet access. Recent enhancements include a user messaging system for direct communication with admins and improved data persistence through migration to a Supabase database.
...
- **User Messaging System**:
  ...
  - Displays users' message history, allowing them to click on messages to view full content.
