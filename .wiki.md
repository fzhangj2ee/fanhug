# Project Summary
FanHug is a web application designed to elevate the live sports betting experience with a user-friendly interface. It enables users to register using email/password or OAuth2 social accounts, integrates with Stripe for secure payments, and utilizes The Odds API for real-time betting data. Key features include automated bet grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration of functionalities, promoting responsible gaming.
