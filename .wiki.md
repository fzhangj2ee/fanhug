# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience with a user-friendly interface. It offers features such as user registration and login via email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management, and the application showcases a colorful logo representing the brand, currently set to version v1264.
