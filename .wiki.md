# Project Summary
FanHug is a secure payment web application tailored for seamless payment processing and live sports betting. The platform provides an intuitive user interface with options for registration and login, including traditional methods and OAuth2 for social media accounts. It integrates with Stripe for secure transactions and The Odds API for real-time betting data. Key features encompass automatic grading of bets, real-time updates, and enhanced betting functionalities. Recent improvements include a new admin dashboard for user management, improved odds calculations, and a refined user interface, including a streamlined sidebar for key navigation options.
...
- **Admin Dashboard**:
  - An "Admin" tab visible only to designated admin users.
