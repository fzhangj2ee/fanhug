# Project Summary
FanHug is a secure web application designed to enhance the live sports betting experience with an intuitive user interface. It allows users to register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management, while a play money feature allows users to explore functionalities without financial risk. Recent updates include a user messaging system for direct communication with admins and improved data persistence through migration to a Supabase database. The application now includes a fix for the Google OAuth login redirect issue.
