...
- **src/pages/**: Various application pages including homepage, live betting, login, signup, My Bets, Wallet, Admin, Donation, Reset Password, Update Password, and Messages pages.
