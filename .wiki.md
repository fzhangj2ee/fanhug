# Project Summary
PayApp is a secure payment web application that facilitates seamless payment processing and live sports betting. It allows users to register and log in through traditional methods or OAuth2 social media accounts. The platform features an intuitive interface, integrating Stripe for secure transactions and The Odds API for real-time betting data. Key functionalities include automatic grading of bets, real-time updates on outcomes, and user-friendly access to betting features.
