# Project Summary
PayApp is a secure payment web application for seamless payment processing and live sports betting. Users can register and log in via traditional methods or OAuth2 social media accounts. The platform features an intuitive interface integrated with Stripe for secure transactions and The Odds API for real-time betting data. Key functionalities include automatic grading of bets, real-time updates on outcomes, and enhanced user accessibility.

# Project Module Description
- **Authentication System**: 
  - Email/password and OAuth2 social login (Google, Facebook).
  - Session management and protected routes.
  - User profile management.

- **Payment Processing**: 
  - Payment button on landing page.
