# Project Summary
FanHug is a web application designed to enhance the live sports betting experience through a user-friendly interface. Users can register via email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payments and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management, while a play money feature allows users to explore functionalities risk-free. FanHug prioritizes responsible gaming and community support, ensuring transparency about operational costs.
...
- **Bet Slip Management**:
  ...
  - Recent bets now show in "My Bets" after placement.
