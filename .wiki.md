# Project Summary
FanHug is a web application that enhances the live sports prediction experience through an intuitive interface. Users can register via email/password or OAuth2 social accounts and securely make payments through Stripe. The app integrates with The Odds API for real-time prediction data, offering features such as automated pick grading, live updates, and an admin dashboard for comprehensive user management. FanHug promotes responsible gaming with a play money feature, allowing users to make predictions on ongoing games without financial risk. A donation page supports the mission of restoring integrity in sports.
