# Project Summary
FanHug is a secure payment web application tailored for enhancing the live sports betting experience. It offers a user-friendly interface for user registration and login, supporting traditional email/password and OAuth2 for social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates efficient user management. Recent updates include a donation page, improved bet slip functionality, and a new "Live" page for users to place bets on ongoing games.
