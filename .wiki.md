# Project Summary
FanHug is a web application that enhances the live sports betting experience with a user-friendly interface. It allows users to register via email/password or OAuth2 social accounts and integrates with Stripe for secure payments. The application utilizes The Odds API for real-time betting data and offers features such as automated bet grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration, promoting responsible gaming.
...
- **Odds Display Issue Fix**:
  - Resolved issues with displaying odds by converting decimal odds to American format correctly.
