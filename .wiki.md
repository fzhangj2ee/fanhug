...
- **Version Display**:
  - Displays the current version number hardcoded in the navbar, positioned right after the FanHug logo, styled subtly for clarity.
...
- **src/components/**: UI components, including updated betting components and Navbar with logo and hardcoded version display.
- **src/hooks/**: Custom hooks for accessing authentication context.
- **.env**: Contains environment variables, including the hardcoded version number for the application.
