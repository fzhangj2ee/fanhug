# Project Summary
FanHug is a secure web application designed to enhance the live sports betting experience through an intuitive user interface. It allows users to register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management, while a play money feature allows users to explore functionalities without financial risk. Recently, an "About FanHug" page was added to explain the benefits of free play-money betting, emphasizing responsible gaming and community support.
...
- **Donation Page**:
  ...
  - Now includes transparency about monthly operational costs.
...
- **About FanHug Page**:
  - A new page explaining the benefits of free play-money betting, emphasizing community engagement and responsible gaming.
...
│   │   ├── About.tsx       # New About page for FanHug
...
- **src/pages/**: Various application pages including homepage, live betting, login, signup, My Bets, Wallet, Admin, Donation, Reset Password, Update Password, Messages, and the new About page.
