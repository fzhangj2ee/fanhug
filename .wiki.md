# Project Summary
FanHug is a secure payment web application designed for seamless payment processing and live sports betting. It features an intuitive user interface for registration and login, supporting both traditional email/password authentication and OAuth2 for social media accounts. By integrating with Stripe for secure transactions and The Odds API for real-time betting data, FanHug enhances the betting experience through automatic grading of bets, real-time updates, and an admin dashboard for user management. Recent improvements have emphasized system stability, user experience, and enhancements to the betting history functionality.
