...
- **Version Display**:
  - The current version number is dynamically sourced from the build environment variable, allowing for automatic updates with each deployment.
