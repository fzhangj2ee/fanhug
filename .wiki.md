# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It provides a user-friendly interface for registration and login, supporting both email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management. Recent updates have restored the logo featuring two hands forming a heart and improved the dynamic display of the version number, which is now set to v1242+.
...
- **Version Display**:
  - The current version number is dynamically sourced from the build environment variable, allowing for automatic updates with each deployment. The version is currently set to v1242+.
...
│   │   └── FanHug.jpg      # Updated colorful heart logo image for the application
