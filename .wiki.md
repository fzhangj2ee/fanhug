# Project Summary
FanHug is a secure payment web application that enhances the live sports betting experience. It features a user-friendly interface for registration and login via traditional email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for efficient user management. Recent enhancements include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and a dynamic version number display in the header for easy identification of the deployed version.
...
5. **Deployment**: For deployment, contact MGX support if the publish button is not visible, or consider alternative platforms temporarily.
