# Project Summary
FanHug is a web application designed to enhance the live sports prediction experience through an intuitive interface. Users can register using email/password or OAuth2 social accounts, with secure payments processed through Stripe. The application leverages The Odds API for real-time prediction data, featuring automated pick grading, live updates, and an admin dashboard for user management. FanHug promotes responsible gaming with a play money feature, allowing users to make predictions on ongoing games. The donation page has been updated to support the mission of restoring integrity in sports.
