# Project Summary
FanHug is a secure payment web application aimed at enhancing the live sports betting experience through a user-friendly interface. It features user registration and login via email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management, and the application is currently set to version v1290, dynamically sourced from the build environment.
