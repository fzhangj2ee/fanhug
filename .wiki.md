# Project Summary
FanHug is a secure payment web application focused on enhancing the live sports betting experience. It features an intuitive user interface for registration and login, supporting both traditional email/password authentication and OAuth2 for social media accounts. By integrating with Stripe for secure transactions and The Odds API for real-time betting data, FanHug provides automatic grading of bets, real-time updates, and an admin dashboard for user management. Recent updates have improved system stability, user experience, and the betting history functionality.
