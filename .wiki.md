# Project Summary
FanHug is a secure payment web application focused on seamless payment processing and live sports betting. It offers an intuitive user interface with registration and login options, including traditional methods and OAuth2 for social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data. Key functionalities include automatic grading of bets, real-time updates, and an enhanced betting experience. Recent improvements feature an admin dashboard for user management, refined odds calculations, and an updated user interface with a streamlined sidebar for navigation.
