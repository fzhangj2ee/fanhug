# Project Summary
FanHug is a secure payment web application aimed at enhancing the live sports betting experience. It offers a user-friendly interface for registration and login, supporting both email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management. Recent updates have restored the logo and improved the dynamic display of the version number, with the current build version now set to v1242.
