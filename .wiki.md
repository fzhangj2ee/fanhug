# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It features an intuitive user interface for registration and login, supporting traditional email/password as well as OAuth2 for social media accounts. Integrating with Stripe for secure transactions and The Odds API for real-time betting data, FanHug automates the grading of bets, provides real-time updates, and includes an admin dashboard for user management. Recent enhancements include a donation page, improved bet slip functionality allowing multiple bets, and an auto-clear feature for the bet slip to optimize user experience.
