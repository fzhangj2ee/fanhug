# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It features an intuitive user interface for registration and login, supporting traditional email/password as well as OAuth2 for social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates efficient user management. Recent enhancements include a donation page, improved bet slip functionality, and a new scrolling feature for better bet visibility. The latest update refines the bet slip behavior, allowing for a clearer distinction between placed and new bets.
