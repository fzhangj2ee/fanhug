# Project Summary
PayApp is a secure payment web application designed for seamless payment processing and live sports betting. Users can register and log in using traditional methods or OAuth2 social media accounts. The platform features an intuitive interface integrated with Stripe for secure transactions and The Odds API for real-time betting data. Key functionalities include automatic grading of bets, real-time updates on outcomes, and user-friendly access to betting features.
