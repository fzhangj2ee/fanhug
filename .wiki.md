# Project Summary
FanHug is a secure payment web application that enhances the live sports betting experience. It provides a user-friendly interface for registration and login, supporting traditional email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates efficient user management. Recent enhancements include a donation page, improved bet slip functionality, and a new "Live" page for users to place bets on ongoing games. The branding has been updated with a new logo that features a transparent background and a colorful gradient design.
...
│   ├── fanhug-logo-transparent.png # New logo image for the application
...
- **src/components/**: UI components, including updated betting components and Navbar with logo.
