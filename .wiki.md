# Project Summary
FanHug is a web application designed to enhance the live sports betting experience with an intuitive user interface. Users can register using email/password or OAuth2 social accounts, and the platform integrates with Stripe for secure payments and The Odds API for real-time betting data. FanHug automates bet grading, provides live updates, and includes an admin dashboard for user management. A play money feature allows users to explore functionalities risk-free, promoting responsible gaming.
