# Project Summary
FanHug is a web application that enhances the live sports betting experience with an intuitive interface. It allows users to register via email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payments and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management, and a play money feature enables users to explore functionalities risk-free. FanHug emphasizes responsible gaming and community support, ensuring transparency about operational costs.
...
└── src/contexts/BettingContext.tsx # Updated betting context
