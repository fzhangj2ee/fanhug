# Project Summary
FanHug is a secure web application designed to enhance the live sports betting experience through an intuitive user interface. Users can easily register and log in using either email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management, and the application features a play money display for convenient wallet access. The current version is v1267.
...
- **Data Storage**:
  - The application uses **browser localStorage** for storing betting data, authentication data is managed through Supabase, and wallet data is under review.
