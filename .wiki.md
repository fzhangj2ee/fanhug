...
- **Bet Slip Management**:
  - Supports accumulation of multiple bets, replacing existing bets for the same game.
  - Auto-clear feature: bet slip clears after 3 seconds post-placement.
  - Includes a "Clear All" button to remove all bets at once.
  - Newly added feature: Automatically hides the "BET PLACED" dialog when new bets are added to the bet slip.
