# Project Summary
FanHug is a web application that enhances the live sports betting experience with a user-friendly interface. Users can register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payments and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for user management, while a play money feature enables users to explore functionalities risk-free. FanHug emphasizes responsible gaming and community support, maintaining transparency about operational costs.
