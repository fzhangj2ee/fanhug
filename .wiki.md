# Project Summary
FanHug is a web application that enhances the live sports prediction experience through an intuitive interface. Users can register via email/password or OAuth2 social accounts, with secure payments processed through Stripe. The application utilizes The Odds API for real-time prediction data, featuring automated pick grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration. Recently, FanHug introduced live predictions, allowing users to make picks on ongoing games while promoting responsible gaming.
...
- **Donation Page**:
  ...
  - Recently updated to include targeted messaging for professional players.
