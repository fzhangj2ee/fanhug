# Project Summary
FanHug is a web application that enhances the live sports prediction experience through an intuitive interface. Users can securely register via email/password or OAuth2 social accounts and make payments through Stripe. The app utilizes The Odds API for real-time prediction data, featuring automated pick grading, live updates, and an admin dashboard for user management. FanHug promotes responsible gaming with a play money feature, allowing users to make predictions without financial risk. A donation page supports its mission of restoring integrity in sports.
