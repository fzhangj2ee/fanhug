# Project Summary
FanHug is a web application that enhances the live sports betting experience through an intuitive user interface. It allows users to register via email/password or OAuth2 social accounts and integrates with Stripe for secure payments and The Odds API for real-time betting data. Key features include automated bet grading, live updates, and an admin dashboard for user management. A play money feature enables users to explore functionalities risk-free, promoting responsible gaming.
