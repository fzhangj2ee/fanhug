# Project Summary
FanHug is a web application designed to enhance the live sports prediction experience through an intuitive interface. It allows users to register via email/password or OAuth2 social accounts and integrates with Stripe for secure payments. The application utilizes The Odds API for real-time prediction data and features automated pick grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration. Recently, FanHug introduced live predictions, enabling users to make picks on ongoing games while emphasizing responsible gaming.
