# Project Summary
FanHug is a secure web application that enhances the live sports betting experience through an intuitive user interface. It allows users to register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management, and the application features a play money display for convenient wallet access. Recent updates include a user messaging system for direct communication with admins and a migration of betting data storage from localStorage to a Supabase database for improved data persistence and security.
...
- **Admin Dashboard**:
  ...
  - Includes a new "Messages" section for viewing user messages.
