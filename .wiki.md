# Project Summary
FanHug is a web application that enhances the live sports prediction experience through an intuitive interface. Users can register with email/password or OAuth2 social accounts, and payments are securely processed via Stripe. The application utilizes The Odds API for real-time prediction data, featuring automated pick grading, live updates, and an admin dashboard for user management. FanHug promotes responsible gaming with a play money feature, allowing users to make predictions on ongoing games. The donation page supports the mission of restoring integrity in sports.
