# Project Summary
FanHug is a web application that enhances the live sports betting experience through an intuitive interface. Users can register via email/password or OAuth2 social media accounts, and the platform integrates with Stripe for secure payments and The Odds API for real-time betting data. It automates bet grading, provides live updates, and features an admin dashboard for user management. A play money option allows users to explore functionalities risk-free, promoting responsible gaming and community support with transparency regarding operational costs.
