# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It features an intuitive user interface for registration and login, supporting both traditional email/password and OAuth2 for social media accounts. By integrating with Stripe for secure transactions and The Odds API for real-time betting data, FanHug offers automatic grading of bets, real-time updates, and an admin dashboard for user management. Recent updates have introduced a donation page, improved bet slip functionality, and an updated currency display to enhance user experience.
