...
- **Admin Dashboard**:
  ...
  - Fetches all bets directly from Supabase and now includes user emails fetched from Supabase's auth system.
...
- **Admin Dashboard Fix**:
  - Updated Admin dashboard to fetch user emails directly from Supabase's auth system using the admin API.
