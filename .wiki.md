# Project Summary
FanHug is a web application that enhances the live sports betting experience through an intuitive interface. It allows users to register via email/password or OAuth2 social accounts and integrates with Stripe for secure payments. The application uses The Odds API for real-time betting data and features automated bet grading, live updates, an admin dashboard for user management, and a play money feature for risk-free exploration. Recently, the application has introduced live betting, enabling users to place bets on ongoing games while maintaining a focus on responsible gaming.
...
- **Live Betting**: 
  ...
  - Users can place bets on games in progress.
  - Automates grading of bets after games finish.
...
- **Automatic Bet Grading**:
  - Automatically grades bets every 120 seconds.
