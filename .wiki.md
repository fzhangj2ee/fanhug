# Project Summary
FanHug is a secure payment web application that enhances the live sports betting experience by providing a user-friendly interface for registration and login. Users can register via email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management. Recent enhancements include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and dynamic version number display sourced directly from the build number.
