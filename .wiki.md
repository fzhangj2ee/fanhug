# Project Summary
FanHug is a secure web application that enhances the live sports betting experience through an intuitive user interface. Users can register and log in using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates user management, while a play money display allows users to explore features without monetary risk. Recent enhancements include a user messaging system for direct communication with admins and improved data persistence through migration to a Supabase database.
