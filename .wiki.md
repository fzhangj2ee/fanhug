# Project Summary
FanHug is a secure payment web application designed for seamless payment processing and live sports betting. It features an intuitive user interface for user registration and login, supporting both traditional email/password authentication and OAuth2 for social media accounts. By integrating with Stripe for secure transactions and The Odds API for real-time betting data, FanHug enhances the betting experience with automatic grading of bets, real-time updates, and an admin dashboard for user management. Recent updates have focused on improving system stability, user experience, and addressing issues related to betting history.
