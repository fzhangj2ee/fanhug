# Project Summary
FanHug is a secure payment web application that enhances the live sports betting experience through a user-friendly interface. Users can register and log in using traditional email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for efficient user management. Recent enhancements include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and a refreshed logo featuring a colorful gradient heart icon prominently displayed in the header.
