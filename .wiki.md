# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience. It offers a user-friendly interface for registration and login, supporting traditional email/password as well as OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates efficient user management, while recent enhancements include a donation page, improved bet slip functionality, and a new "Live" page for users to place bets on ongoing games. The branding has been updated to feature a new colorful logo.
