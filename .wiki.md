# Project Summary
FanHug is a web application designed to enhance the live sports prediction experience through an intuitive interface. Users can register via email/password or OAuth2 social accounts and make secure payments through Stripe. The app integrates with The Odds API for real-time prediction data, featuring automated pick grading, live updates, and an admin dashboard for user management. FanHug promotes responsible gaming with a play money feature, allowing users to make predictions without financial risk. A donation page supports its mission of restoring integrity in sports.
