# Project Summary
FanHug is a web application aimed at enhancing the live sports betting experience through an intuitive interface. Users can register using email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payments and The Odds API for real-time betting data. FanHug automates bet grading, provides live updates, and features an admin dashboard for user management. A play money option allows users to explore functionalities risk-free, promoting responsible gaming and community support with transparency regarding operational costs.
