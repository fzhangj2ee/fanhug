# Project Summary
FanHug is a secure payment web application that enhances the live sports betting experience through a user-friendly interface. It supports registration and login via email/password and OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard is available for user management. The application now features an updated logo, ensuring brand consistency, and the dynamic version display has been improved to reflect the latest build version, currently set to v1264.
...
- **Version Display**:
  - The current version number is dynamically sourced from the build environment variable, allowing for automatic updates with each deployment. The version is currently set to v1264.
...
│   │   └── FanHug.jpg      # Correct colorful heart logo image for the application
