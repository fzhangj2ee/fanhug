# Project Summary
FanHug is a secure payment web application designed for seamless payment processing and live sports betting. It features an intuitive user interface with registration and login options, including traditional methods and OAuth2 for social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data. Key functionalities include automatic grading of bets, real-time updates, and an enhanced betting experience. Recent enhancements consist of a new admin dashboard for user management, improved odds calculations, and a refined user interface with a streamlined sidebar for key navigation options.
