# Project Summary
FanHug is a secure payment web application designed to enhance the live sports betting experience through a user-friendly interface. It allows users to register and log in using traditional email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure transactions and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard facilitates efficient user management. Recent updates include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and a refreshed logo featuring a colorful gradient heart icon prominently displayed in the header.
