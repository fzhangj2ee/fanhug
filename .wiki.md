# Project Summary
FanHug is an innovative secure payment web application aimed at enhancing the live sports betting experience. It features a user-friendly interface for registration and login via email/password or OAuth2 social media accounts. The platform integrates with Stripe for secure payment processing and The Odds API for real-time betting data, automating bet grading and providing live updates. An admin dashboard allows for efficient user management. Recent updates include a donation page, improved bet slip functionality, a new "Live" page for ongoing games, and a dynamic version number display in the header for easy identification of the deployed version.
