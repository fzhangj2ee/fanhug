...
export default function Login() {
  ...
  const { signIn, signInWithOAuth, error, loading, clearError } = useAuth();
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-3 h-4 w-4 text-[#b1bad3]" />
                <Input
                  id="password"
                  type="password"
            ...
            <div className="flex items-center justify-between">
              <Link
                to="/reset-password"
                className="text-sm text-[#53d337] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full border-t border-[#2a2d2f]" />
            </div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#1a1d1f] px-2 text-[#b1bad3]">Or continue with</span>
            </div>
          </div>
          ...
          <div className="text-center text-sm text-[#b1bad3]">
            ...
            <Link to="/signup" className="text-[#53d337] hover:underline font-medium">
              Sign up
            </Link>
          </div>
        </CardContent>
